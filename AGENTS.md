...
- **CatPaw**: 开发流程遵循新版 CatPaw runtime（`~/.claude/catpaw/runtime-policy.md`）。本项目 artifacts 入口为 `.catpaw/index.md`；旧 `todos/` 仅作 legacy reference，未经明确确认不得删除、移动、untrack 或批量清理。
